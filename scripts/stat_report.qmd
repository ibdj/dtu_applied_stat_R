...
This report is an introduction to the use of PCA, principal component analysis, applied in ecology and vegetation composition exploration. PCA is a widely use method in vegetation ecology as is allows for exploration of structures and patterns. E.i. to detect groupings of vegetation types or ecotones in the dataset in quetion. Classification in to vegetation types or ecotones is a much used practice as generalisations and groupings are useful in upscaling and applicable generalisations in ecological practices. However, since the ecological factors influencing the distribution, occurrences and range of plant species and individual are gradients/spectrums determining specific distingushable groups in vegetation types are difficult determine, as there will be as many transitinal types. 
But this is one of the reasons that PCA and the visualisation of the PCA is usefull as is also allows for the 
